...
namespace ProductApp.Persistance.Context
{
    public class ApplicationDbContext : DbContext
    {
        ...
        {
            // Product'ı özelleştirmek için.
            // Şu an uygulama Veri Tabanı vs'den data çekmiyor her şey in memory şeklinde proje her şeyiyle oluştuğunda dataları eklesin.
            // Şu an data olarak uygulamayı beslemek için bu Productları ekliyoruz.
